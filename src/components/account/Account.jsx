...
export default function Account() {
  ...
  function uploadPicture(e) {
    ...
    axios
      .post(`${process.env.REACT_APP_PROXY}/users/image`, formData)
      .then((response) => {
        if (response.data.error) {
          ...
          axios
            .patch(`${process.env.REACT_APP_PROXY}/users/${currentUser._id}`, {
  ...
  function updateUserDetails(e) {
    e.preventDefault();
    axios
      .patch(`${process.env.REACT_APP_PROXY}/users/${currentUser.id}`, {
  ...
  return (
    <div className="container">
        ...
        <div className="col-4">
          <div className="container border rounded mt-4 mb-4 p-3 text-center">
            <img
              src={
                currentUser &&
                `${process.env.REACT_APP_PROXY}/image/${currentUser.profileImage}`
              }
            ...
            <form onSubmit={(e) => updateUserDetails(e)}>
              <div className="container">
                <div className="row">
                  <div className="col">
                    <div className="mb-3">
                      ...
                      <input
                        ...
                        id="firstName"
                        onChange={(e) => handleUserDetailsChanges(e)}
                  ...
                  <div className="col">
                    <div className="mb-3">
                      <label htmlFor="laseName" className="form-label">
                        Last name
                      </label>
                      <input
                        type="text"
      ...
      <button
        onClick={() => userSignOut()}
        style={{ width: "150px" }}
        className="btn d-block mx-auto btn-primary mb-3 mt-3"
      >
        Sign out
      </button>
    </div>
